...
const NavBar = ()=>{
   ...
   function isActive(route){
    ...
    return(
        <nav>
        <div className="nav-wrapper #1565c0 grey darken-2">
          <Link href="/"><a className="brand-logo left">Online Store</a></Link>
          <ul id="nav-mobile" className="right">
          <li className={isActive('/cart')}><Link href="/cart"><a>My Cart</a></Link></li>
            {
